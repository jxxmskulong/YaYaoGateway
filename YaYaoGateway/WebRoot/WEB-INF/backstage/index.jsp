		...
		<div class="row-fluid">
			<div class="span12">
				<h3 class="text-center">
					<strong><span class="marker"><strong style="color:green;font-size:36px;">雅耀官网管理系统<br/><small style="color:white;">Ya Yao Mall Management System</small></strong></span></strong>
				</h3>
			</div>
		</div>
	</div>
	<div class="row" id="ht_login"  style="width:350px;height:35%;padding:10px;margin:100px auto 200px;border-radius:10px;background-color:green;">
